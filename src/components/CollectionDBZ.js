...
import DBZWALL from './dbzwall.jpeg'
...
const CollectionDBZ = () => {
  ...
  const productList = [
    { id:1, 
      name: "Freeza", 
      image:"images/freeza.jpg", 
      price:"99900", 
      category:"Anime" },
    { id:2, 
      name: "Vegeta Blue", 
      image:"images/vegetablue.jpg", 
      price:"99900", 
      category:"Anime" },
    { id:3, 
      name: "Goku UI", 
      image:"images/gokuui.jpg", 
      price:"99900", 
      category:"Anime" },
    { id:4, 
      name: "Broly", 
  ...
  return (
    <Wrapper className="section" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${DBZWALL})`, backgroundRepeat: "no-repeat", backgroundSize: 'cover',backgroundPosition: 'center',}}>
